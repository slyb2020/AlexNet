...
import datetime
from ApplicationPanel import ApplicationPanel
from DatasetOperationPanel import DatasetOperationPanel
from AlexNetPanel import AlexNetPanel
...
class MainPanel(wx.Panel):
    ...
    def ReCreateFoldPanel(self, fpb_flags, state=0):
        ...
        vbox.Add(self.applicationBTN, 0, wx.EXPAND | wx.TOP | wx.BOTTOM, 5)
        vbox.Add(self.datasetOperationBTN, 0, wx.EXPAND | wx.TOP | wx.BOTTOM, 5)
        vbox.Add(self.AlexNetBTN, 0, wx.EXPAND | wx.TOP | wx.BOTTOM, 5)
...
class WorkZonePanel(wx.Panel):
    def __init__(self, parent, master, log):
        ...
        hbox = wx.BoxSizer()
        self.applicationPNL = ApplicationPanel(self.notebook, self.log)
        self.notebook.AddPage(self.applicationPNL, "门型识别面板")
        ...
        self.alexnetPNL = AlexNetPanel(self.notebook, self.log)
        self.notebook.AddPage(self.alexnetPNL, "YOLOv1面板")
